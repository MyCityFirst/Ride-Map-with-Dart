...
class PassengerDriverRouteView extends StatefulWidget {
  const PassengerDriverRouteView({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  _PassengerDriverRouteViewState createState() =>
      _PassengerDriverRouteViewState();
}

class _PassengerDriverRouteViewState extends State<PassengerDriverRouteView> {
  Timer? _timer;
